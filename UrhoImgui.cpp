...
namespace Urho3D
{
	...
	// Constructor
	//
	UrhoImgui::UrhoImgui(Context * context) :
		Object(context),
		isActive(false)
	{
		IMGUI_CHECKVERSION();
		...
		// Subscribe to events
		SubscribeToEvent(E_POSTUPDATE, URHO3D_HANDLER(UrhoImgui, HandlePostUpdate));
		SubscribeToEvent(E_ENDRENDERING, URHO3D_HANDLER(UrhoImgui, HandleEndRendering));

		SubscribeToEvent(E_KEYUP, URHO3D_HANDLER(UrhoImgui, HandleKeyUp));
		SubscribeToEvent(E_KEYDOWN, URHO3D_HANDLER(UrhoImgui, HandleKeyDown));
		SubscribeToEvent(E_TEXTINPUT, URHO3D_HANDLER(UrhoImgui, HandleTextInput));

		SubscribeToEvent(E_TOUCHBEGIN, URHO3D_HANDLER(UrhoImgui, HandleTouchBegin));
		SubscribeToEvent(E_TOUCHEND, URHO3D_HANDLER(UrhoImgui, HandleTouchEnd));
		SubscribeToEvent(E_TOUCHMOVE, URHO3D_HANDLER(UrhoImgui, HandleTouchMove));
	}
	...
	// GetClipboardText
	//
	const char * UrhoImgui::GetClipboardText(void* user_data)
	{
	...
	// SetClipboardText
	//
	void UrhoImgui::SetClipboardText(void* user_data, const char * text)
	{
	...
	// HandlePostUpdate
	//
	void UrhoImgui::HandlePostUpdate(StringHash eventType, VariantMap & eventData)
	{
	...
	// HandleEndRendering
	//
	void UrhoImgui::HandleEndRendering(StringHash eventType, VariantMap & eventData)
	{
	...
	// HandleKeyUp
	//
	void UrhoImgui::HandleKeyUp(StringHash eventType, VariantMap & eventData)
	{
	...
	// HandleKeyDown
	//
	void UrhoImgui::HandleKeyDown(StringHash eventType, VariantMap & eventData)
	{
	...
	// HandleTextInput
	//
	void UrhoImgui::HandleTextInput(StringHash eventType, VariantMap & eventData)
	{
	...
	// HandleTouchBegin
	//
	void UrhoImgui::HandleTouchBegin(StringHash eventType, VariantMap & eventData)
	{
	...
	// HandleTouchEnd
	//
	void UrhoImgui::HandleTouchEnd(StringHash eventType, VariantMap & eventData)
	{
	...
	// HandleTouchMove
	//
	void UrhoImgui::HandleTouchMove(StringHash eventType, VariantMap & eventData)
	{
